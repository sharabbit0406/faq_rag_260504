...
(function () {
  ...
  styleEl.textContent =
    ...
    'background:#A6D8F5;color:#1e293b;border:none;border-radius:50%;' +
    'cursor:pointer;box-shadow:0 4px 20px rgba(166,216,245,.6);z-index:999999;' +
    'display:flex;align-items:center;justify-content:center;padding:0;' +
    'transition:transform .2s,box-shadow .2s}' +
    '#faq-chat-btn:hover{transform:scale(1.1);box-shadow:0 6px 28px rgba(166,216,245,.8)}' +
  ...
  var ICON_CHAT = '<svg width="22" height="22" viewBox="0 0 24 24" fill="#1e293b"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>';
  var ICON_CLOSE = '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#1e293b" stroke-width="2.5" stroke-linecap="round"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>';
